...
sudo docker stack deploy -c ./GitLab/docker-compose.yml  traefik
sudo docker stack deploy -c ./GitLab-Runners/docker-compose.yml  traefik
sudo docker stack deploy -c ./postgre/docker-compose.yml  traefik
